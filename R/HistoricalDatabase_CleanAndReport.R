...
write.csv(FINAL, "P:/Research_and_Monitoring/Cailin_OMalley/Historical Database/Reports/Database_app/piechart/FINAL_DB.csv")
write.csv(FINAL, "P:/Research_and_Monitoring/Cailin_OMalley/Historical Database/Reports/Database_app/RipRest_graph/FINAL_DB.csv")
write.csv(FINAL, "P:/Research_and_Monitoring/Cailin_OMalley/Historical Database/Reports/Database_app/TotalFunding/FINAL_DB.csv")
write.csv(FINAL, "P:/Research_and_Monitoring/Cailin_OMalley/Historical Database/Reports/Database_app/FundingSources/FINAL_DB.csv")
write.csv(FINAL, "P:/Research_and_Monitoring/Cailin_OMalley/Historical Database/Reports/Database_app/TotalCostshare/FINAL_DB.csv")
write.csv(FINAL, "P:/Research_and_Monitoring/Cailin_OMalley/Historical Database/Reports/Database_app/HUC12_Measurements/FINAL_DB.csv")
